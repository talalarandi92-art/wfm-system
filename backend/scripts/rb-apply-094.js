#!/usr/bin/env node
/* Apply migration 094 (PRODUCTIVITY band = RANGES at the top, D-082) DIRECTLY — idempotent, no shared migrate runner.
...
(async () => {
  const file = '094_productivity_range_band.sql';
