...
import { HEALTH_THRESHOLDS } from '../health/integration-health.service';
...
export class SprinklrService {
  ...
  async getLatestSnapshot(tenantId: string) {
    ...
    return {
      ...
      // Same threshold the bridge-health page uses — see HEALTH_THRESHOLDS.
      isStale: Date.now() - snap.receivedAt > HEALTH_THRESHOLDS.sprinklrLiveSec * 1000,
      queueFeedMissing,
    };
  }
