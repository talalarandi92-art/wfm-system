...
// THE canonical Erlang-B/C kernel (R2.2): this file's former private copy was
// lifted VERBATIM into @common/erlang — results are bit-identical.
import { serviceLevel, asa, findMinAgents, effectiveServersPerAgent } from '@common/erlang';
