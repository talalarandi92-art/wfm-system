...
@Module({ controllers: [ReconController, RosterFairnessController, RosterHourlyController, RosterGenerateController], providers: [ReconService, RosterIngestionService, RosterSharedService] })
