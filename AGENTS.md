...
It must be placed in Codex Project Instructions and/or in the repository as:

- `PROJECT_CONTEXT.md`
- `AGENTS.md`
- or `WFM_PROJECT_INSTRUCTIONS_FULL.md`

The purpose is to make Codex understand the full project from the beginning until the latest discussion, including:
- What was planned
- What was built
- What was modified
...
- Codex must verify build before continuing.
...
# 35. Required First Message For New Codex Session
...
2. Put the same file in repository root as `AGENTS.md`.
3. Ask Codex to audit current repo.
