...
import { Calendar, Zap, Shuffle, Megaphone, CalendarCog, Clock, Wand2 } from 'lucide-react';
...
type HubTab = 'schedule' | 'generator' | 'hourly' | 'demand' | 'rotation' | 'campaigns' | 'changes';
...
const TABS: { key: HubTab; icon: typeof Calendar; ar: string; en: string; permission: string }[] = [
  ...
  // (Director 2026-07-03) everything schedule-related lives HERE — hourly HC + demand/health
  // moved in from AnalyticsHub so generate → headcount check → schedule are ONE place.
