              ...
              <tbody>
                {data.rows.map((r, i) => (
                  <tr key={i} className="border-t hover:bg-white/[0.03]" style={{ borderColor: dark ? 'rgba(255,255,255,0.04)' : 'rgba(0,0,0,0.04)' }}>
                    ...
                    <td className="px-2.5 py-2 text-center font-bold" style={{ color: r.deductionApplies ? '#ef4444' : r.effectiveLateMin > 0 ? '#f59e0b' : '#475569' }}>{mins(r.effectiveLateMin)}{r.deductionApplies && <span className="text-[8px] text-red-400"> خصم</span>}</td>
