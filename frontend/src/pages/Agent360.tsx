...
export default function Agent360Page() {
  ...
  const RFIELDS: [string,string][] = [['date','Date'],['day','Day'],['week','Week'],['month','Month'],['shiftCode','Shift'],['originalShift','Orig Shift'],['attendanceStatus','Status'],['hrStatus','HR Code'],['sysLogin','Sys In'],['sysLogout','Sys Out'],['workedMin','Worked'],['lateMin','Late'],['lateCategory','Late Band'],['earlyMin','Early'],['otBefore','OT Before'],['otAfter','OT After'],['otTotal','OT Total'],['conformance','Conf %'],['permission','Permission'],['dataQuality','Data Quality'],['netPoints','Net Points']];
  const RKPIS: [string,string][] = [['scheduledDays','Scheduled'],['workedDays','Worked'],['officeDays','Office'],['wfhDays','WFH'],['sickDays','Sick'],['absenceDays','Absence'],['lateDays','Late days'],['lateMin','Late min'],['earlyMin','Early min'],['otMin','OT'],['otBefore','OT before'],['otAfter','OT after'],['conformance','Conf %'],['permissionCount','Permissions'],['netPoints','Net Points'],['scQuality','Quality (pts)'],['scAht','AHT (pts)'],['scFcr','FCR (pts)'],['scProductivity','Productivity (pts)'],['scCtr','CTR (pts)'],['scQuiz','Quiz (pts)']];
